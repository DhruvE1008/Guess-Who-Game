...
public class GameStateContext {
  ...
  public void handleSendChatClick(TextArea txtArea, String input, String person, String aiResponse)
      throws IOException {
    gameStartedState.handleSendChatClick(txtArea, input, person, aiResponse);
  }
}
